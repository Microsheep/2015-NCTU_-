<?php
    ...
    $QA=[
        ...
        array(
            ...
            "info" => "
            小編認為呢，到了交大就要有交不到女朋友的準備...噢不是啦！想要脫魯當然要先加入學聯會啊！學聯會的成員超過一百人，其中大半都是暖男/新好男人，也不乏和小編一樣漂亮的正妹（誤），怎麼可以不好好把握呢？當然女孩子也可以嘗試在大馬路上故意讓考卷被吹走（前提是你考好一點）、和同學走在一起的時候踉蹌一下（小心不要跌倒）或是看電影的時候假裝很冷（結果對方沒有帶外套）男孩們也可以嘗試在餐廳裡面搭訕（然後被警察抓走）或是出去玩的時候借人家外套（然後被發現有汗臭味）不過小編還是認為加入學聯會最快啦！（撒花）
            "
        ),
        array(
            "head" => "",
